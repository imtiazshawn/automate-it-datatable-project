...
<template>
  <div class="card">
    ...
    >
      <Column field="roll" header="Roll" sortable style="width: 25%"></Column>
      <Column field="student_id" header="Student ID"></Column>
      <Column field="name" header="Name" sortable style="width: 25%"></Column>
      <Column field="academic_details.grade" header="Grade"></Column>
      <Column field="academic_details.marks.math" header="Math" sortable style="width: 25%"></Column>
      <Column field="academic_details.marks.science" header="Science" sortable style="width: 25%"></Column>
      <Column field="academic_details.marks.english" header="English" sortable style="width: 25%"></Column>
